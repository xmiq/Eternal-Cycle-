...
- [x] **FR-011 — GM/AI Context Assembly, Mandatory Read Discipline, and Gameplay Turn Persistence** — Defined a relevance-filtered Context Assembly Layer, Current Scene Context and hierarchical derived summaries, mandatory pre-resolution owner reads, explicit Affected Set determination, automatic validated persistence before turn closure and delivery, idempotent failure recovery, next-turn reload, fresh-session reconstruction, specialist integration, and an explicit specification/runtime-host boundary.
