...
- [ ] **FR-002 — Reincarnation Candidate Selection** — Clarify GM-adjudicated candidate selection within existing Reincarnation constraints. Prior lives, Final Death, Interlife time, Soul and world state, embodiment routes, cosmology, Age, consequences, and campaign themes may inform judgement without a mandatory weighting formula, guaranteed candidate, arbitrary reward or punishment, or farmable engineered-death route.
- [ ] **FR-003 — Soul Depth Information Visibility** — Define hybrid visibility for qualitative Soul Depth: explicitly reveal legitimately established properties and capabilities while deeper unknown structures remain hidden or appear through existing in-world signs and discovery mechanics. Preserve informed play without creating an omniscient progression meter.
...
- [ ] **FR-006 — Adaptive Skill Consolidation and Merge Rules** — Clarify regular evidence-based merging of substantially overlapping Adaptive Skills while preserving accumulated development, history, and provenance. Deepen an existing relevant Skill under repeated equivalent challenge, retain mechanically meaningful distinctions, permit genuinely distinct adaptation, and prevent injury or hardship farming from producing unlimited narrow Skills.
- [ ] **FR-007 — Conceptual Skill Scope and Historical Interpretation** — Clarify that Skill identity, acquisition, development, applications, failures, predecessors, merges, Evolution, and embodiment-specific expression govern broad or Conceptual Skill scope. Names describe rather than grant capability; reasonable extensions require legitimate development, and FR-006 consolidation must preserve meaningful boundaries.
- [ ] **FR-008 — Soul Weapon Rarity and Equipment Relevance** — Clarify that developed Soul Weapons may substantially outperform ordinary weapons without redefining the world's normal equipment baseline. Rarity, Soul binding, individual ownership, non-transferability, and actual growth preserve ordinary equipment relevance without imposing artificial parity.
- [ ] **FR-009 — World Contact, Travel, and Reincarnation Discretion** — Clarify that world knowledge, contact or channel, travel route, and Reincarnation possibility are distinct. Player wishes and established world connections meaningfully inform GM adjudication under FR-002 and existing rules but neither guarantee access nor create an unrestricted destination menu.
