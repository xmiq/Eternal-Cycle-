...
- [Soul Rules Index](soul/README.md) - identity, persistence, Reincarnation, Soul systems, their interactions, and shared safeguards.
...
- [Human Rules Index](human/README.md) - canonical reading order, claim-resolution sequence, ownership map, guarantees, and boundaries for Human Classes, Professions, traditions, schools, advancement, institutions, Class Evolution, and progression limits.
...
- [Soul Weapons Index](soul-weapons/README.md) - complete Soul Weapon state model, reading order, claim resolution, system interfaces, guarantees, and repository scope.
...
- [Magic Rules Index](magic/README.md) - complete reading order, claim resolution, ownership boundaries, guarantees, authority, and campaign-record boundary.
- [Magical Development](progression/MAGICAL_DEVELOPMENT.md) - capability-specific practice, evidence, attribution, transfer, rebuilding, and assessment across the completed Magic frameworks.
...
- [GM Rules Index](gm/README.md) - reading order and campaign-data boundary for the canonical GM framework.
...
- [Life Archive and Old-Soul Indexing](persistence/LIFE_ARCHIVE.md) - stable Life identities, Soul Overview indexes, finalized Life Summaries, player-visible Life Over views, and old-Soul retrieval.
- [Memory Continuity, Fading, and Recall](soul/MEMORY_CONTINUITY.md) - persistent but imperfect autobiographical memory, significance-sensitive fading, bounded cue-triggered recall, and player/character/GM information separation.
...
This repository contains reusable rules, governance, templates, and GM guidance only. Campaign saves, current characters, live world state, inventories, active quests, story summaries, and playthrough history belong outside it.
