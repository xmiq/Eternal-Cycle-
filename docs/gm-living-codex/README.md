...
1. [GM Living Codex Design](GM_LIVING_CODEX.md) - purpose, authority, inclusion, consultation, campaign divergence, safeguards, and the approved implementation plan.
...
3. [Persistence Model](PERSISTENCE_MODEL.md) - separate SQLite authority, normalized schema, Codex revisions and migrations, validation, Google Drive deployment, backups, and full-save completion.
4. [Reproductive Compatibility](REPRODUCTIVE_COMPATIBILITY.md) - sparse directional species relationships, nonzero scoped probabilities, assistance methods, viability and fertility separation, schema constraints, and full-save operation.
5. [Lineage, Hybridization, and Evolutionary Inheritance](LINEAGE_AND_EVOLUTIONARY_INHERITANCE.md) - Lineage Templates, expression, sparse profiles, Mana equalization, Evolutionary Attenuation, Level 0 Instincts, Ancestral Echoes, and stabilization.

Every Codex document remains subordinate to existing Species Development, Monster Evolution, Skill, Magic, Soul, World Engine, GM, and persistence owners.
