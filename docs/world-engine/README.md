...
15. [World Gates and World-Contact Events](GATES_AND_WORLD_CONTACT.md) defines extraordinary contact interfaces; distinguishes world knowledge, contact, travel, and Reincarnation possibility; and governs Contact Domains, Gate Bases, endpoints, channels, compatibility, lifecycle, asymmetry, closure, and persistent consequences.
