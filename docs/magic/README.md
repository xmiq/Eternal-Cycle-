...
Later Phase 7 documents will add magical affinities, spell formation, rituals, enchanting, alchemy, divine magic, forbidden magic, detailed Development integration, and World Engine effects in roadmap order. A mention of one of those subjects in current canon does not make its detailed rules complete.
...
| Persistent identity, memory, alignment, and Reincarnation | [Soul Engine](../soul/README.md) |
| Weapon Soul personhood, bond, form, and manifestation | [Soul Weapons](../soul-weapons/README.md) |
| Live Mana state, sources, ecology, consequences, and campaign discoveries | External Campaign Record under the [Game Master Framework](../gm/GAME_MASTER_FRAMEWORK.md) |
