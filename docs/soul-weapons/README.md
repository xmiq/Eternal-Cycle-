...
The remaining Phase 6 subjects are implemented only when the [Roadmap](../../design/ROADMAP.md) marks their dedicated tasks complete. A reference to personality, evolution, Weapon Echoes, Legacy Weapons, compatibility, Weapon Manifestations, or unconventional forms does not grant those unfinished rules by implication.
