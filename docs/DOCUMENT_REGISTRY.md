...
| [Life Archive and Old-Soul Indexing](persistence/LIFE_ARCHIVE.md) | Stable Life identity, Soul Overview indexes, finalized Life Summaries, Life Over derivation, and historical drill-down | Consumed by players, GMs, migration, validation, and future retained-development, Skill-history, memory, context, and Soul-bond objectives. |
