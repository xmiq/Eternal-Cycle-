...
| [Memory Continuity, Fading, and Recall](soul/MEMORY_CONTINUITY.md) | Autobiographical Memory identity, significance, fading, dormancy, cues, fragments, and incarnation-specific recall | Consumed by Character Knowledge, Context Assembly, Relationships, Timeline, and Reincarnation without granting perfect recall. |
...
| [Soul-Bound Companion Fate and Reincarnation Continuity](soul/SOUL_BOUND_COMPANIONS.md) | Pair-specific fate bond identity, Convergence Intervals, eventual causal reunion, route limits, and agency boundaries | Consumed by Reincarnation, world simulation, persistence, Relationships, Memory Continuity, chronology, and Context Assembly. |
...
| [Retained Cross-Life Development](progression/RETAINED_CROSS_LIFE_DEVELOPMENT.md) | Cross-Life contribution eligibility, Embodiment Relevance, bounded stacking, Historical Territory, Skill familiarity/boost separation, and recalculation | Consumed by attributes, Skills, Reincarnation, Life Archive, persistence, GMs, and player views. |
| [Skill Consolidation and Historical Scope](skills/SKILL_CONSOLIDATION_AND_SCOPE.md) | Routine redundant-Skill consolidation, Development reconciliation, lineage preservation, and historical scope adjudication | Consumed by Adaptive Skills, Conceptual Skills, Skill records, persistence, retained development, GMs, and player views. |
...
| [Player Start and Resume](gm/PLAYER_START_AND_RESUME.md) | Player intent for new-game creation, campaign discovery, consent-aware setup, and resume selection | Consumed by human and AI interfaces while stable infrastructure identifiers remain internal. |
...
| [Canonical Data Ownership](persistence/CANONICAL_DATA_OWNERSHIP.md) | Mutable-fact ownership, persistent non-autonomous Entity identity anchors, normalized domain boundaries, current-placement ownership, data classifications, and the reserved autonomous domain | Consumed by campaign schemas, Save Updates, migrations, validation, templates, Context Assembly, and summary systems. |
| [Life Archive and Old-Soul Indexing](persistence/LIFE_ARCHIVE.md) | Stable Life identity, Soul Overview indexes, finalized Life Summaries, Life Over derivation, and historical drill-down | Consumed by players, GMs, migration, validation, retained-development, Skill-history, Memory Continuity, context, and future Soul-bond objectives. |
| [Long-Horizon Simulation Summaries](persistence/LONG_HORIZON_SUMMARIES.md) | Stable Historical Period identity, causal compression, continuity hooks, historical references, retrieval indexes, revisions, and filtered transition derivation | Consumes specialist outcomes and is consumed by Time Skips, Reincarnation gaps, Ages, Resets, migration, validation, and Context Assembly. |
| [Autonomous Registry](persistence/AUTONOMOUS_REGISTRY.md) | Persistent autonomous identity, Models, Individuals, Groups, autonomy, Controller assignments, reconstruction, memory and upgrade lineage, networks, last-confirmed state, migration, and validation | Consumed by campaign schemas, world simulation, Relationships, Infrastructure, Projects, Context Assembly, and validation. |
| [Visual Identity](persistence/VISUAL_IDENTITY.md) | Sparse established appearance facts, body and Incarnation scope, Model and Individual boundaries, historical recovery, explicit adoption, and representation ownership | Consumed by campaign schemas, Characters, Autonomous Registry, Life Archive, Context Assembly, image handoffs, migration, and validation. |
...
| [Managed Operations](persistence/MANAGED_OPERATIONS.md) | Durable long-running work identity, lifecycle, idempotency, recovery, timeout, authorization, status discovery, and safe result evidence | Consumed by Managed services, administrative interfaces, diagnostics, and recovery tooling. |
| [Running Eternal Cycle](persistence/RUNNING_ETERNAL_CYCLE.md) | Runtime-neutral capability discovery, readiness, setup handoff, source selection, and start/resume operation | Consumed by players, GMs, runtime profiles, and implementation quick starts. |
...
| [Context Assembly and Gameplay Turn Persistence](ai/CONTEXT_ASSEMBLY_AND_TURN_PERSISTENCE.md) | Gameplay Turn states, relevance-filtered Context Packets, mandatory reads, automatic persistence, cache hierarchy, failure/retry, and next-turn reload | Binds existing Campaign State, Save Update, validation, execution-profile, and adapter procedures without owning campaign facts. |
