...
24. [Running Eternal Cycle](RUNNING_ETERNAL_CYCLE.md) defines runtime-neutral configuration discovery, pre-migration recovery, readiness, first-run setup handoff, source selection, and start/resume operation.
