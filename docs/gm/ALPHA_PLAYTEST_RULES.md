...
Soul, Development, Skill, Monster Evolution, Human Classes and Professions, the complete Soul Weapon framework, Mana, and Magical Affinities are canonical within their stated scopes. Later Magic, World Engine, GM-tool, content, formula, and generator tasks are not complete merely because adjacent ownership boundaries are canonical.
...
- spell formation, rituals, enchanting, alchemy, divine magic, forbidden magic, and other incomplete Magic procedures beyond the canonical Mana and affinity frameworks;
...
The completed [Soul Engine](../soul/README.md), [Development System](../progression/README.md), [Skill Engine](../skills/README.md), [Monster Evolution](../monster-evolution/README.md), [Human Classes and Professions](../human/README.md), [Soul Weapons](../soul-weapons/README.md), [Mana](../magic/MANA.md), and [Magical Affinities](../magic/MAGICAL_AFFINITIES.md) frameworks apply directly. A claim within their completed scope is not Provisional merely because it is unusual or combines several systems.
...
Apply canonical [Mana](../magic/MANA.md) and [Magical Affinities](../magic/MAGICAL_AFFINITIES.md) where relevant. Until the remaining Phase 7 tasks are complete, establish only a small Provisional model for the still-incomplete parts of local magic. State its:
...
Keep Mana, affinity, magical knowledge, potential, Access, Capacity, Reserves, control, authority, and Embodied Expression distinct under [Mana](../magic/MANA.md), [Magical Affinities](../magic/MAGICAL_AFFINITIES.md), and [Magical Development](../progression/MAGICAL_DEVELOPMENT.md). Reincarnation does not grant unrestricted spell inheritance, and one local Provisional model is not universal Magic canon.
