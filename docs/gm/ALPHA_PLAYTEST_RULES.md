...
- [Soul Weapon Foundations](../soul/SOUL_WEAPON_FOUNDATIONS.md), [Dormant Weapon Souls](../soul-weapons/DORMANT_WEAPON_SOULS.md), [Awakening Conditions](../soul-weapons/AWAKENING_CONDITIONS.md), [Soul Intertwining](../soul-weapons/SOUL_INTERTWINING.md), [Weapon Personalities](../soul-weapons/WEAPON_PERSONALITIES.md), and [Weapon Evolution](../soul-weapons/WEAPON_EVOLUTION.md);
...
- detailed Weapon Echoes, Legacy Weapons, Soul Weapon compatibility, Weapon Manifestations, and unconventional forms;
...
- treat unfinished Weapon Echo, Legacy Weapon, compatibility, manifestation, and unconventional-form claims as Provisional unless an existing rule already owns the exact effect.
