...
- dungeon, faction, world-event, time-skip, and Age-transition generators;
...
- use completed canonical GM owners, including [Encounter Generation](ENCOUNTER_GENERATOR.md), [Monster Generation](MONSTER_GENERATOR.md), and [NPC Generation](NPC_GENERATOR.md), within their stated scopes;
