...
- [Soul Weapon Foundations](../soul/SOUL_WEAPON_FOUNDATIONS.md), [Dormant Weapon Souls](../soul-weapons/DORMANT_WEAPON_SOULS.md), [Awakening Conditions](../soul-weapons/AWAKENING_CONDITIONS.md), [Soul Intertwining](../soul-weapons/SOUL_INTERTWINING.md), and [Weapon Personalities](../soul-weapons/WEAPON_PERSONALITIES.md);
...
- detailed Soul Weapon evolution, Weapon Echoes, Legacy Weapons, compatibility, Weapon Manifestations, and unconventional forms;
...
- treat unfinished evolution, Weapon Echo, Legacy Weapon, compatibility, manifestation, and unconventional-form claims as Provisional unless an existing rule already owns the exact effect.
