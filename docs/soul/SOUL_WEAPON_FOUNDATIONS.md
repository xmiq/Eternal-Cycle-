...
- survival at the edge of death;
- impossible resistance;
- sacrifice;
- a vow upheld under extreme pressure;
- a moment in which both weapon and wielder are permanently changed.
...
An executioner's history might instead produce:
