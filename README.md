...
4. **Weapons may awaken.** Any weapon or meaningful tool may develop a Weapon Soul through extreme shared experience.
...
- [`docs/soul-weapons/README.md`](docs/soul-weapons/README.md) - Soul Weapon reading order, ownership boundaries, and detailed Phase 6 rules.
...
The repository foundation, Soul Engine, Development System, Skill Engine, Monster Evolution, and Human Classes & Professions phases are complete. The current phase is **Phase 6 — Soul Weapons**, and the sole active task is **Define unconventional Soul Weapons**.
