...
public sealed class ManagedConfigurationService(IConfiguration configuration) : IManagedConfigurationService
{
    ...
    [
        ...
        Optional("EternalCycle:Administration:ManagedRuleCacheDirectory", "Managed Rule Source cache", "Service-owned cache root for acquired rule source objects.", "Administration", "path", null, null, "AdvancedOperator", ValidateOptionalText),
