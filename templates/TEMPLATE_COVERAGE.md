...
| Phase 2 - Development System | [Development Profile](DEVELOPMENT_PROFILE_TEMPLATE.md), [Character Record](CHARACTER_TEMPLATE.md) | six capability layers, distinct Tracks, retained redevelopment, evidence, and present embodiment |
